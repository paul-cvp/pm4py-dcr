...
def execute_script():
    ...
    nete.places.add(p2e)
    nete.places.add(p3e)
    arc1 = petri_utils.add_arc_from_to_with_check(sourcee, create_order_e, nete, type="stochastic_arc")
    arc2 = petri_utils.add_arc_from_to_with_check(create_order_e, p1e, nete, type="stochastic_arc")
    arc3 = petri_utils.add_arc_from_to_with_check(p1e, skip_e, nete, type="stochastic_arc")
    arc4 = petri_utils.add_arc_from_to_with_check(p1e, item_issue_e, nete, type="stochastic_arc")
    arc5 = petri_utils.add_arc_from_to_with_check(item_issue_e, p2e, nete, type="stochastic_arc")
    arc6 = petri_utils.add_arc_from_to_with_check(p2e, item_fixed_e, nete, type="stochastic_arc")
    arc7 = petri_utils.add_arc_from_to_with_check(item_fixed_e, p3e, nete, type="stochastic_arc")
    arc8 = petri_utils.add_arc_from_to_with_check(skip_e, p3e, nete, type="stochastic_arc")
    arc9 = petri_utils.add_arc_from_to_with_check(p3e, send_package_e, nete, type="stochastic_arc")
    arc10 = petri_utils.add_arc_from_to_with_check(send_package_e, targete, nete, type="stochastic_arc")
    arc1.weight = {2: 1, 3: 2}
    arc2.weight = {2: 1, 3: 2}
    arc3.weight = {2: 2, 3: 1}
    arc4.weight = {1: 1}
