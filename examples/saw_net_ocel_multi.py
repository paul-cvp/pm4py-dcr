...
def execute_script():
    ...
    neto.places.add(p3o)
    neto.places.add(p4o)
    arc1o = petri_utils.add_arc_from_to_with_check(sourceo, create_order_o, neto, type="stochastic_arc")
    arc2o = petri_utils.add_arc_from_to_with_check(create_order_o, p1o, neto, type="stochastic_arc")
    arc3o = petri_utils.add_arc_from_to_with_check(p1o, item_issue_o, neto, type="stochastic_arc")
    arc4o = petri_utils.add_arc_from_to_with_check(p1o, skip_o, neto, type="stochastic_arc")
    arc5o = petri_utils.add_arc_from_to_with_check(item_issue_o, p2o, neto, type="stochastic_arc")
    arc6o = petri_utils.add_arc_from_to_with_check(p2o, item_fixed_o, neto, type="stochastic_arc")
    arc7o = petri_utils.add_arc_from_to_with_check(item_fixed_o, p3o, neto, type="stochastic_arc")
    arc8o = petri_utils.add_arc_from_to_with_check(p3o, send_package_o, neto, type="stochastic_arc")
    arc9o = petri_utils.add_arc_from_to_with_check(skip_o, p3o, neto, type="stochastic_arc")
    arc10o = petri_utils.add_arc_from_to_with_check(send_package_o, p4o, neto, type="stochastic_arc")
    arc11o = petri_utils.add_arc_from_to_with_check(p4o, pay_order_o, neto, type="stochastic_arc")
    arc12o = petri_utils.add_arc_from_to_with_check(pay_order_o, targeto, neto, type="stochastic_arc")
    arc1o.weight = {1: 3}
    arc2o.weight = {1: 3}
    arc3o.weight = {1: 1}
    arc4o.weight = {1: 2}
    ...
    neto.places.add(p2e)
    neto.places.add(p3e)
    arc1 = petri_utils.add_arc_from_to_with_check(sourcee, create_order_e, neto, type="stochastic_arc")
    arc2 = petri_utils.add_arc_from_to_with_check(create_order_e, p1e, neto, type="stochastic_arc")
    arc3 = petri_utils.add_arc_from_to_with_check(p1e, skip_e, neto, type="stochastic_arc")
    arc4 = petri_utils.add_arc_from_to_with_check(p1e, item_issue_e, neto, type="stochastic_arc")
    arc5 = petri_utils.add_arc_from_to_with_check(item_issue_e, p2e, neto, type="stochastic_arc")
    arc6 = petri_utils.add_arc_from_to_with_check(p2e, item_fixed_e, neto, type="stochastic_arc")
    arc7 = petri_utils.add_arc_from_to_with_check(item_fixed_e, p3e, neto, type="stochastic_arc")
    arc8 = petri_utils.add_arc_from_to_with_check(skip_e, p3e, neto, type="stochastic_arc")
    arc9 = petri_utils.add_arc_from_to_with_check(p3e, send_package_e, neto, type="stochastic_arc")
    arc10 = petri_utils.add_arc_from_to_with_check(send_package_e, targete, neto, type="stochastic_arc")
    arc1.weight = {2: 1, 3: 2}
    arc2.weight = {2: 1, 3: 2}
    arc3.weight = {2: 2, 3: 1}
    arc4.weight = {1: 1}
